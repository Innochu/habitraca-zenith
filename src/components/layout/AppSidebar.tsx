...
export function AppSidebar() {
  ...
  const getNavClassName = (active: boolean) =>
    `flex items-center gap-3 rounded-lg px-3 py-2 transition-smooth hover:bg-sidebar-accent ${
      active ? "bg-gradient-primary text-primary-foreground shadow-elegant" : "text-sidebar-foreground"
    }`;
